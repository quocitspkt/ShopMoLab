using AutoMapper;
using ShopMoLap.Common.Exceptions;
using ShopMoLap.Model.Models;
using ShopMoLap.Service;
using System;
...
using ShopMoLap.Web.App_Start;
using ShopMoLap.Web.Infrastructure.Core;
using ShopMoLap.Web.Infrastructure.Extentions;
using ShopMoLap.Web.Models;

namespace ShopMoLap.Web.Api
{
